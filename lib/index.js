...
var debug = require('debug')('nikko:core');
...
Nikko.prototype.onDone = function(result){

};

Nikko.prototype.onError = function(err){
...
Nikko.execute = function(command, config){
    //TODO: Do we want to keep context or new Nikko instance
    //each time?
    var nikko = new Nikko();
    if(!command) {
